                ...
                {OXYGEN_OPTIONS.map(opt => (
                  ...
                  >
                    <div className="relative flex items-center">
                      ...
                      />
                      <div className="w-6 h-6 border-2 border-gray-600 rounded-md peer-checked:bg-red-500 peer-checked:border-red-500 peer-focus-visible:ring-2 peer-focus-visible:ring-yellow-400 ring-offset-2 ring-offset-black transition-all flex items-center justify-center text-black font-bold">
                        {oxygen.includes(opt) && '✓'}
                      </div>
                    </div>
