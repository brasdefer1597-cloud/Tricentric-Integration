...
const LevelBadge: React.FC<LevelBadgeProps> = ({ level, xp, nextLevelXP }) => {
  ...
  return (
    <div
      ...
      role="img"
      aria-label={`Nivel ${level}, ${xp} de ${nextLevelXP} puntos de experiencia`}
    >
      <div className="bg-gradient-to-br from-yellow-600 to-red-600 rounded-full p-1 shadow-lg" aria-hidden="true">
      ...
      <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-full px-2" aria-hidden="true">
