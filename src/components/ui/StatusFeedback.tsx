...
const StatusFeedback: React.FC<StatusFeedbackProps> = ({
  ...
  return (
    <div
      ...
      className={`fixed top-4 left-1/2 -translate-x-1/2 z-[100] w-[calc(100%-2rem)] max-w-md p-4 rounded-xl shadow-2xl flex items-center justify-between gap-4 animate-in fade-in slide-in-from-top-2 duration-300 ${config.bg} ${config.text || 'text-white'}`}
    >
